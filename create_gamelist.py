...
def scrape(platform, input_dir, scrape_flags, config_path, scrape_module, user_creds):
    opts = '-s {0}'.format(scrape_module if scrape_module else 'screenscraper')
...
def run(platform, input_dir, scrape_module=None, user_creds=None, scrape_flags=None, game_list_flags=None,
...
if __name__ == "__main__":
    ...
    print(opts)
    run(opts.platform, opts.input_dir, opts.scrape_module, opts.user_creds,
